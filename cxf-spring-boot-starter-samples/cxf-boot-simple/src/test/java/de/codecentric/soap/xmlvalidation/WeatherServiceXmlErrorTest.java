...
public class WeatherServiceXmlErrorTest {
	...
	private void checkXMLError(Resource testFile, FaultType faultContent) throws BootStarterCxfException, IOException {
		...
		assertEquals(faultContent.getId(), weatherException.getBusinessErrorId(), "The correct BusinessId is missing in WeatherException according to XML-scheme.");
	}
}
